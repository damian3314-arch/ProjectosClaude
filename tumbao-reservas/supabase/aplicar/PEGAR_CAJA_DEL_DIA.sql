-- =====================================================================
-- PEGAR EN SUPABASE  ·  La caja del día es la plata del día
--
-- QUÉ ARREGLA
-- El 11 de agosto la tirilla dijo "Reservas de la página: $45.000".
-- Ese día entraron $135.000: nueve personas pagaron. La caja contó tres,
-- porque sumaba por la fecha de la CLASE y no por cuándo entró la plata.
--
-- Después de pegar esto, la caja de un día cuenta lo que entró ESE día,
-- que es lo único que se puede cuadrar contra el banco y contra el
-- efectivo del cajón.
--
-- QUÉ NO TOCA
--   · ni un movimiento de caja: la plata de la puerta sigue igual
--   · ni un cierre ya firmado: no escribe en caja_cierres
--   · ni una reserva
--
-- Es solo la función caja_del_dia, y se parchea por dentro en vez de
-- reemplazarla, para no borrar el arreglo del doble conteo que otra
-- sesión metió en producción y no quedó en el repositorio.
--
