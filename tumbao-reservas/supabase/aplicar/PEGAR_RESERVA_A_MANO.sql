-- ═══════════════════════════════════════════════════════════════════════
--
--   TUMBAO — CREAR RESERVA A MANO DESDE EL PANEL
--
--   Pégalo en el SQL Editor de Supabase y dale Run.
--   Se puede correr las veces que quieras.
--
--   Para cuando el cliente escribe por WhatsApp, manda el comprobante,
--   y recepción lo anota. Queda confirmada de una, porque ella tiene el
--   soporte en la mano.
--
--   LO IMPORTANTE: no se salta el aforo. Pasa por tomar_cupo, la misma
--   puerta que una reserva normal. Con la clase llena responde SIN_CUPO,
--   igual que a un cliente.
--
--   Probado: 6 comprobaciones, incluida la del sobrecupo.
--
-- ═══════════════════════════════════════════════════════════════════════
