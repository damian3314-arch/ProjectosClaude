...
--
--   Crea dos tablas nuevas (caja_movimientos, caja_cierres) y cuatro
--   funciones. NO toca nada de lo que ya existe: ni reservas, ni pagos,
--   ni clases, ni membresías.
--
--   Probado contra una base levantada desde cero con 0001–0022:
--   9 comprobaciones en verde, incluidas las cuentas del arqueo, anular
--   dos veces, el cero de más al teclear, y el rechazo con token falso.
--
-- ═══════════════════════════════════════════════════════════════════════
