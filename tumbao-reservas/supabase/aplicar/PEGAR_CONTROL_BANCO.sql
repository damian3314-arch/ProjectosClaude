-- =====================================================================
-- PEGAR EN EL EDITOR SQL DE SUPABASE — control del banco en la caja
--
-- Qué hace, en corto:
--   · Añade a caja_cierres dos columnas para dejar constancia de lo que
--     decía el banco en el momento de cerrar.
--   · caja_del_dia empieza a devolver un bloque `banco`.
--   · caja_cerrar guarda esa foto.
--
-- No borra nada, no toca `pagos`, no cambia la comparación con AdminGym.
-- Se puede correr dos veces sin problema.
--
-- Después de pegarlo, en la pestaña Caja aparece una quinta tarjeta.
-- Antes de pegarlo la página funciona igual, solo que sin esa tarjeta.
-- =====================================================================
