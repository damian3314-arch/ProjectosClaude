-- =====================================================================
-- TUMBAO — quince minutos de gracia
--
-- Quien mira la página a las 7:00 en punto para la clase de las 7:00 no
-- la ve, y lo que entiende no es "ya empezó" sino "no hay cupo". En la
-- vida real esa persona llega a las 7:10 y entra.
--
-- Con esto la clase se sigue ofreciendo y se sigue pudiendo reservar
-- hasta 15 minutos después de su hora. El aforo manda igual que
-- siempre: la gracia NO es un pase para sobrevender.
--
-- Toca tres sitios, y los tres importan:
--   tomar_cupo   y  tomar_cupos   dejan tomar el cupo
--   clases_para                   deja que la clase se OFREZCA
--
-- El tercero es el que la persona ve. Sin él la clase desaparece del
-- listado y no hay dónde hacer clic.
--
-- Se puede pegar a cualquier hora y correrlo dos veces no hace daño: si
-- ya está aplicado lo dice y no vuelve a tocar nada.
--
