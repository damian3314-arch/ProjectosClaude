-- =====================================================================
-- PEGAR EN SUPABASE  ·  Al abrir la semana, recalcular los cupos
--
-- POR QUÉ, EN UNA LÍNEA
-- Al abrir la semana del 17 la página se puso a ofrecer 30 cupos en las
-- clases de entre semana. El aforo es 30, pero 20 ya eran de afiliados
-- con plan: los libres eran 12. Estuvo vendiendo cupos que no existen.
--
-- Ya lo corregí a mano corriendo la importación de afiliados. Esto es
-- para que no vuelva a pasar: abrir_semana() recalcula sola.
--
-- Además devuelve `cupos_que_no_cuadran`, y el workflow del sábado
-- revienta si sale distinto de cero — ofrecer puestos que ya tienen
-- dueño es peor que no abrir la semana.
--
-- QUÉ NO TOCA
--   · ninguna clase, reserva, pago ni cierre
--   · solo reemplaza abrir_semana(), que nació ayer y nadie más ha tocado
--
